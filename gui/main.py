...
class MainWindow(QMainWindow):
    ...
    def setup(self):
        ...
        self.installation_redis = visualize_installation.visualize_installation()
        ...
        self.installation_vagrant = visualize_installation_vagrant.visualize_installation()
        ...
        #Celery Manager
        self.celery_mng = celery_mng.CeleryManager(self.status_celery, self.celery_start_button, self.celery_stop_button,
                                                   self.plainTextEdit_celery_log)
        #self.celery_mng.set_base_path(self.base_path)
        ...
        self.test_runner = run_test.run_test(self.start_execution_test, self.status_label_test,self.celery_mng,self.redis_hdi,self.vagrant_manager)
        self.log_execution_test.clicked.connect(self.test_runner.get_file_log)

        # List tests to execute.
        self.list_test = metta_test_visualizer.metta_test_visualizer(self.gridLayout_6, self.test_runner)
